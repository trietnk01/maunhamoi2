            ...
            <div class="col-md-6">
                <div class="product-item-box">
                    ...
                    <div class="border-item-detail-product">
                        <h2 class="product-item-box-title-2"><a href="<?php echo @$permalink; ?>"><?php echo wp_trim_words(@$title, 20, "[...]" ) ; ?></a></h2>
                        <div class="product-detail-exerpt"><?php echo wp_trim_words( @$excerpt , 30,"[...]" ) ; ?></div>
