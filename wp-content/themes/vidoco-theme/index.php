										...
										<div class="col-md-6">
											<div class="category-frontend">
												<div class="category-frontend-halo">
													<div class="category-frontend-title-left"><a href="<?php echo @$term_za_category_link; ?>"><?php echo wp_trim_words( @$term_za_category_data->name, 99, "[...]" ) ; ?></a></div>
													<div class="clr"></div>
												</div>
												<div>
												...
												<div class="duong-vien">
													<h3 class="title-category-frontend"><a href="<?php echo @$term_za_category_link; ?>"><?php echo wp_trim_words(@$term_za_category_data->description, 30,  "[...]" ) ; ?></a></h3>
